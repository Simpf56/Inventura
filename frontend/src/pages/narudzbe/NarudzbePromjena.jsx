...
export default function NarudzbePromjena() {
    ...
    const { narudzbaSifra, stavkaSifra } = useParams();
        console.log("Narudžba šifra:", narudzbaSifra);
        console.log("Stavka šifra:", stavkaSifra);
                            ...
                            <tbody>
                                {stavke_narudzbe && stavke_narudzbe.map((e, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <Button variant="success" onClick={()=>navigate(`/narudzbe/${narudzbaSifra}/stavke_narudzbe/${stavkaSifra}`)}>
